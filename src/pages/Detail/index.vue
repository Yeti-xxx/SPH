          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr, i) in spuSaleAttrList" :key="i">
                ...
                <dd changepirce="0" :class="{ active: spuItem.isChecked == 1 }"
                  v-for="(spuItem, i) in spuSaleAttr.spuSaleAttrValueList" :key="i"
                  @click="changeActive(spuItem, spuSaleAttr.spuSaleAttrValueList)">
...
export default {
  ...
  methods: {
    // 切换商品属性高亮
    changeActive(spuItem, spuSaleAttrValueList) {
      // 先将此行所有属性高亮置为0
