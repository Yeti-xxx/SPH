<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address, i) in addressInfo" :key="i">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(order, i) in orderInfo.detailArrayList" :key="i">
          <li>
            <img :src="order.imgUrl" style="width:80px;height:100px" alt="">
          </li>
          <li>
            <p>
              {{ order.skuName }}</p>
